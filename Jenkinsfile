        ...
        stage('increment version'){
            steps{
                script{
                    ...
                    sh 'mvn build-helper:parse-version versions:set newVersion=\\\${parsedVersion.majorVersion}.\\\${parsedVersion.minorVersion}.\\\${parsedVersion.nextIncrementalVersion} versions:commit'
